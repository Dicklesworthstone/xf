...
LOG="$ROOT/docs/embedding_candidates_2025_11+_log.txt"
OUT_JSON="$ROOT/docs/embedding_candidates_2025_11+.json"
OUT_MD="$ROOT/docs/embedding_candidates_2025_11+.md"
SUMMARY="$ROOT/docs/embedding_candidates_2025_11+_summary.json"
CUTOFF="2025-11-01"
...
echo "[run] embedding discovery" | tee -a "$LOG"
python3 "$ROOT/scripts/discovery/embedding_discovery.py" \
  --cutoff "$CUTOFF" \
